...
The core of the visual system lives in `packages/os-core/`. This is the package you'll work with most. It exports:
...
```tsx
// packages/os-core/src/theme/HyperCardTheme.tsx
...
All part names are centralized in a single file (`packages/os-core/src/parts.ts`) and imported as constants. You never hardcode a data-part string — always import from `PARTS`.
...
| File | What It Does |
|------|-------------|
| `packages/os-core/src/theme/index.ts` | Entry point — imports all base CSS packs |
| `packages/os-core/src/theme/HyperCardTheme.tsx` | The React scoping wrapper |
| `packages/os-core/src/theme/desktop/tokens.css` | All ~90 CSS custom properties |
| `packages/os-core/src/theme/desktop/primitives.css` | Component CSS rules (~300 lines) |
| `packages/os-core/src/theme/desktop/shell.css` | Desktop chrome (windows, menus, icons) |
| `packages/os-core/src/theme/desktop/animations.css` | Keyframe animations |
| `packages/os-core/src/theme/classic.css` | "Classic" theme override |
| `packages/os-core/src/theme/modern.css` | "Modern" (macOS-like) theme override |
| `packages/os-core/src/theme/desktop/theme/macos1.css` | macOS System 1 desktop skin |
| `packages/os-core/src/parts.ts` | All 104 data-part name constants |
| `packages/os-core/src/components/widgets/` | All widget implementations |
| `packages/os-core/src/components/shell/windowing/` | Desktop shell, windows, menus |
...
**File: `packages/os-core/src/theme/desktop/tokens.css`**
...
**File: `packages/os-core/src/parts.ts`**
...
### File: `packages/os-core/src/theme/desktop/primitives.css`
...
**File: `packages/os-core/src/theme/desktop/shell.css`**
...
```ts
// packages/os-core/src/desktop-theme-macos1.ts
...
Create `packages/os-core/src/theme/desktop/theme/macos-aqua.css`:
...
Create `packages/os-core/src/desktop-theme-macos-aqua.ts`:
...
import '../../../packages/os-core/src/theme/desktop/theme/macos-aqua.css';
...
**File: `packages/os-core/src/theme/classic.css`**
...
**File: `packages/os-core/src/theme/modern.css`**
...
**File: `packages/os-core/src/theme/desktop/theme/macos1.css`**
...
**File: `packages/os-core/src/components/widgets/Toast.tsx`** (16 lines)
...
**File: `packages/os-core/src/components/widgets/Btn.tsx`** (24 lines)
...
**File: `packages/os-core/src/components/widgets/ProgressBar.tsx`** (28 lines)
...
Open `packages/os-core/src/parts.ts` and add three new entries:
...
Create `packages/os-core/src/components/widgets/StatusBadge.tsx`:
...
Add to `packages/os-core/src/theme/desktop/primitives.css`:
...
Add to `packages/os-core/src/components/widgets/index.ts`:
...
Create `packages/os-core/src/components/widgets/StatusBadge.stories.tsx`:
...
**File: `packages/os-core/src/components/widgets/SelectableList.tsx`**
...
The confirm-runtime package (`packages/os-confirm/`) is the richest example of widget composition in the system. It demonstrates how to build complex, multi-step operator workflows by orchestrating simple widgets.

### The Composition Host

**File: `packages/os-confirm/src/components/ConfirmRequestWindowHost.tsx`**
...
|------------------|-----------------------|
| `packages/os-core/src/components/widgets/` | `Engine/Widgets/` |
| `packages/os-core/src/components/shell/` | `Engine/Shell/` |
| `packages/os-core/src/plugin-runtime/` | `Engine/PluginRuntime/` |
...
- [ ] Register part names in `packages/os-core/src/parts.ts`
- [ ] Create component in `packages/os-core/src/components/widgets/`
...
- [ ] Add rules to `packages/os-core/src/theme/desktop/primitives.css`
...
**Fix:** Add it to `packages/os-core/src/parts.ts`. Use camelCase for the key and kebab-case for the value. Remember to add it before the `} as const;` closing.
